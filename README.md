...
* [x] List anything else that you can get done to improve the app functionality!
  [x] Used GSON for robust deserialization
  [x] User ButterKnife for reducing boilerplate.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://raw.githubusercontent.com/snmuppa/twitter-redux/master/demos/Twitter_Redux_Demo-1.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
